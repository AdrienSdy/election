...
Devise.setup do |config|
  ...
  # config.secret_key = '7796db3f9eccd7b9d9e86de861ecbb0af1ef1c7158c2dc6f0951e25
  # ed9d5370d3277137cfd968fc903daf4362ac434e010525c22c753ac0ab8f5477a3ecb8c7b'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'a.sasia.ldy@gmail.com'
  ...
  # for example, `config.params_authenticatable = [:database]` will enable it
  # only for database (email + password) authentication.
  # config.params_authenticatable = true

  # Tell if authentication through HTTP Auth is enabled. False by default.
  # It can be set to an array that will enable http authentication only for the
  # given strategies,
  # for example, `config.http_authenticatable = [:database]` will enable it
  # only for database authentication. The supported strategies are:
  ...
  # that, for bcrypt (the default algorithm), the cost increases
  # exponentially with the number of stretches (e.g. a value of 20 is already
  # extremely slow: approx. 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = 'd2867027ef6fb69d33000b47f7e9b1281d9aa35edcb67f9a430cdd78b87
  # 3c7ab0224d1637b44b73e67c1940e1d93db2e5efd16ca1238a1d8c3e10124faa8bd3b'
  ...
  # is stored in unconfirmed_email column, and copied to email column on
